...
class store_detail extends WP_Widget {
function store_detail() {
		$widget_args = array(
			'classname'		=> 'store_detail',
			'description'	=> __('Details of Store', 'arras'),
		);
		$this->WP_Widget('store_detail', __('Store Details', 'arras'), $widget_args);
	}
